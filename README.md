...
# Credits
This repository builds off of [this repository](https://github.com/ricardorei/lightning-text-classification), which is built off of an older PyTorch-Lightning version. This repository also contains the code from [example from pytorch-lightning](https://pytorch-lightning.readthedocs.io/en/stable/notebooks/lightning_examples/text-transformers.html).
