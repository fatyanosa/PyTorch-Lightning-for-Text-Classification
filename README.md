...
Rank #57 in [GLUE Benchmark Leaderboard](https://gluebenchmark.com/leaderboard) using distilbert-base-uncased with manually tuned hyperparameters.
...
# Credits
This repository builds off of [this repository](https://github.com/ricardorei/lightning-text-classification), which is built off of an older PyTorch-Lightning version. This repository also contains code samples from [pytorch-lightning](https://pytorch-lightning.readthedocs.io/en/stable/notebooks/lightning_examples/text-transformers.html).
